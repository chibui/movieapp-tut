describe('From now filter', function () {
    ...
    it('should return value of years ago for date object', function () {
        var value = new angular.mock.TzDate(0, '2013-07-01T00:00:00.000Z'),
            baseDate = new angular.mock.TzDate(0, '2015-08-01T21:00:00.000Z');
    ...
    it('should return value of months ago for date object', function () {
        var value = new angular.mock.TzDate(0, '2015-01-01T21:00:00.000Z'),
            baseDate = new angular.mock.TzDate(0, '2015-08-01T21:00:00.000Z');
    ...
    it('should return value of one month ago', function () {
        var value = new angular.mock.TzDate(0, '2015-01-01T21:00:00.000Z'),
            baseDate = new angular.mock.TzDate(0, '2015-02-01T21:00:00.000Z');
